/*
    ...
    "Позиция по рядам выходит за пределы массива" или "Позиция по колонкам выходит за 
    пределы массива"
...
class UserInputToCompileForTest
{
    ...
    // Поиск элемента по позициям в массиве
    ...
    // Проверка позиций на вхождение в массив (помещаются ли Х и Y в заданный массив)
    public static bool ValidatePosition(int[,] array, int x, int y)
    {
        ...
        return false;        //Напишите свое решение здесь
    }
    ...
    public static void PrintResult(int[,] numbers, int x, int y)
    {
        ...
        {
            System.Console.WriteLine("[хреново по х]");
        }
        else if (y > numbers.GetLength(0))
        {
            System.Console.WriteLine("[хреново по y]");
        }
